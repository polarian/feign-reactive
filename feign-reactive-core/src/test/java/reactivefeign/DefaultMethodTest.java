...
public class DefaultMethodTest {
	...
	public void shouldWrapExceptionWithMono() throws JsonProcessingException {
		...
		IceCreamOrder errorOrder = client.throwExceptionMono().onErrorReturn(
				throwable -> throwable.equals(IcecreamServiceApi.RUNTIME_EXCEPTION), orderGenerated).block();
	...
	public void shouldWrapExceptionWithFlux() throws JsonProcessingException {
		...
		IceCreamOrder errorOrder = client.throwExceptionFlux()
				.onErrorReturn(throwable -> throwable.equals(IcecreamServiceApi.RUNTIME_EXCEPTION),
						orderGenerated)
				.blockFirst();
